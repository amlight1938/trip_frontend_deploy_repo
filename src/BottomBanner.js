            ...
            <div className="bottom-banner-strip" style={strip_styles}>
                ...
                <div className="bottom-banner-writing-strip" >
                    <div className="banner-text-section" style={{flex: ".7"}}>
                        ...
                        <p>
                            I am a self-taught software engineer with a background in Aerospace Engineering from The University of Texas at Austin. I have been a fulltime engineer since 8/2021. My skills include React, Ruby on Rails, Python, Java, C, C#, SQL, HTML/CSS, Matlab, and Object-Oriented Programming.
                        </p>
